...
export default function AdminUsersScreen() {
  ...
  const canDeleteUser = (target: ManagedUser) => {
    ...
    if (target.papel === "administrador" && !isAdmin) return false; // coord nao deleta admin
    if (target.papel === "administrador" && isAdmin) return false; // admin nao deleta outro admin
    return true;
  };
